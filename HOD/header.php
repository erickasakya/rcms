...
<body>
   ...
   <!--/content-inner-->
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			<div class="header-section">
						<!--menu-right-->
						<div class="top_menu actions">
							<!--/profile_details-->
								<div class="profile_details_left">
									<ul class="nofitications-dropdown actions">
	...
	<!--/down-->
	<div class="down">	
		  <a href="index.html"><img src="../images/in7.jpg"></a>
	...
	echo ucfirst($hodfname." ".$hodlname);}?></span></a>
	...
	<div class="menu actions">
		<ul id="menu" >
			...
			<li id="menu-academico" ><a href="Complaints.php"><span class="glyphicon glyphicon-envelope"></span> <span>Complaints</span></a></li>
			<li id="menu-academico" ><a href="Unapproved.php"><span class="glyphicon glyphicon-envelope"></span> <span>Unapproved</span></a></li>
			<li id="menu-academico" ><a href="approved.php"><span class="glyphicon glyphicon-envelope"></span> <span>Approved</span></a></li>
			 <li id="menu-academico" ><a href="assigncourseunit.php"><span class="glyphicon glyphicon-education"></span></i> <span>Register Teaching</span></a></li>
			 <li id="menu-academico" ><a href="teachings.php"><i class="lnr lnr-book"></i> <span>Teachings</span></a></li>
			 <li id="menu-academico" ><a href="importcourseunit.php"><span class="glyphicon glyphicon-education"></span></i> <span>Import Course units</span></a></li>
	  </ul>
	</div>
	</div>
	<div class="clearfix"></div>		
