<?php
 require 'header.php';
?>
   <div class="graph-visual tables-main animated fadeInRight">
                  ...
                  ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" placeholder="Username" name="UserName" required value="<?php echo $hodemail;?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Old password" name="Oldpaswd" autofocus value="" required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="New password" name="Newpaswd" id="Newpaswd" data-minlength="4" value="" required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="new password" name="Newpaswdagain" value="" required data-match="#Newpaswd" data-match-error="Whoops, the passwords don't match">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="author">
            ...
            <img class="avatar border-gray down" src="<?php if(!empty($profilepic)){ echo $profilepic=getuserfield('profilepic');}else{ echo '../images/tim_vector.jpe';}?>" alt="profile picture"/>
              <h4 class="title">
              <?php echo ucfirst($hodfname." ".$hodlname);?><br />
              </h4>
            </a>
        </div>
