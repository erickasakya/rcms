                  ...
                  ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Username" name="UserName" required value="<?php echo $Adminemail;?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="New password" name="Newpaswd" data-minlength="6" required id="password">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="new password" name="Newpaswdagain" required data-match="#password" data-match-error="Whoops, the passwords don't match">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="author">
            ...
            <img class="avatar border-gray down" src="<?php if(!empty($profilepic)){ echo $profilepic=getuserfield('profilepic');}else{ echo '../images/tim_vector.jpe';}?>" alt="profile picture"/>
              <h4 class="title">
              <?php echo ucfirst($Adminfname." ".$Adminlname);?><br />
              </h4>
            </a>
        </div>
