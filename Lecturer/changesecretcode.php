...
<?php
    ...
    ?>
    <form class="form" id="formsubmit" data-toggle="validator" action="" method="POST">
                  ...
                  ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Current Password" name="currentpaswd" autofocus required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="New Secret Code" name="Newcode" data-minlength="4" required id="Newcode">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
