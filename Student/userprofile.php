                  ...
                  ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly required class="form-control" placeholder="Username" name="UserName" value="<?php echo $studentNo;?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="new password" name="Newpaswdagain" required data-match="#Newpaswd" data-match-error="Whoops, the passwords don't match" required>
                             <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="author">
            ...
            <img class="avatar border-gray down" src="<?php if(!empty($profilepic)){ echo $profilepic=getuserfield('profilepic');}else{ echo '../images/tim_vector.jpe';}?>" alt="profile picture"/>
              <h4 class="title">
              <?php echo ucfirst($studentfname." ".$studentlname);?><br />
              </h4>
            </a>
        </div>
